...
Page({
  ...
  setSeat: function() {
    ...
    for (let d = 0 ; d < this.data.seats.length; d++) {
        totalArray[this.data.seats[d].yCoord -1][this.data.seats[d].xCoord - 1] = this.data.seats[d]
        if (this.data.seats[d].type == "danren") {
            
            if (this.data.seats[d].status == "ok") {
                totalArray[this.data.seats[d].yCoord -1][this.data.seats[d].xCoord - 1].iconSrc = "../../../image/icon/seatPre.png"
            } else {
                totalArray[this.data.seats[d].yCoord -1][this.data.seats[d].xCoord - 1].iconSrc = "../../../image/icon/seatDone.png"
            }
        } else if (this.data.seats[c].type == "road") {//过道
            totalArray[this.data.seats[d].yCoord -1][this.data.seats[d].xCoord - 1].iconSrc = "";
        }
    }
